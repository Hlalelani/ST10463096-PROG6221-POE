    ...
    public class ResponseHandler
    {
        ...
        private void InitializeResponses()
        {
            responses = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "smishing", "✉️ Smishing (SMS phishing) uses text messages with fake links or requests. Never click links in texts from unknown numbers, and don't reply to requests for personal info. Legitimate organisations never ask for OTPs via SMS." },
                ...
                { "safe download", "⬇️ Only download files from official websites or app stores. Avoid cracked software or pirated media – they often contain malware. Scan downloads with antivirus before opening." },
                ...
                { "oversharing", "⚠️ Oversharing on social media gives attackers material for social engineering. Avoid posting your full name, birthdate, address, travel plans, and photos of ID documents. Scammers use this info to answer security questions or impersonate you." },
                ...
                { "zero day", "⚠️ A zero‑day vulnerability is a software flaw unknown to the vendor – hackers exploit it before a patch exists. Protect yourself by keeping software updated, using a firewall, and limiting your exposure (e.g., disabling unnecessary services)." },
                ...
                // ----- PROTECTION TOOLS -----
                { "antivirus", "🛡️ Antivirus software detects and removes malicious software. Use a reputable one (e.g., Windows Defender, Bitdefender, Kaspersky, Avast) and keep it updated. Run regular scans and enable real‑time protection." },
                ...
                { "zero trust", "🛡️ Zero Trust is a security model that assumes no one is trusted by default – even inside your network. It means verifying every access request, using least‑privilege access, and continuously monitoring. For individuals, adopt a 'never trust, always verify' mindset for emails and links." },
                { "cloud security", "☁️ When using cloud services (Google Drive, iCloud, OneDrive), enable 2FA, use strong passwords, and review sharing settings. Encrypt sensitive files before uploading, and backup important data locally too." },
