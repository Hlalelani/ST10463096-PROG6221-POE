    ...
    public class ResponseHandler
    {
        ...
        private void InitializeResponses()
        {
            responses = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "hey", "Hey! Let us talk about online safety." },
                { "how are you", "I am doing great! Always ready to help you stay secure online. How are you doing today?" },
                { "how are you doing", "I am functioning perfectly! Cybersecurity is my passion. What would you like to learn about?" },
                ...
                { "password manager", "Password managers generate, store, and autofill strong passwords for you. Popular ones: Bitwarden (free and open-source), 1Password, LastPass, and Dashlane. They encrypt your vault with a master password – make that one strong and memorable!" },
                ...
                { "brute force", "Brute force attacks try millions of password combinations. Protect against them by using long, complex passwords and rate-limiting or account lockout mechanisms on your accounts." },

                // ----- TWO-FACTOR & MFA -----
                { "two factor authentication", "Two-factor authentication (2FA) adds a second verification step – something you have (phone) or are (fingerprint). Even if someone steals your password, they cannot get in without the second factor. Use authenticator apps (Google Authenticator, Authy) instead of SMS for better security." },
                ...
                { "smishing", "Smishing (SMS phishing) uses text messages with fake links or requests. Never click links in texts from unknown numbers, and do not reply to requests for personal info. Legitimate organisations never ask for OTPs via SMS." },
                ...
                { "firewall", "A firewall monitors incoming and outgoing network traffic and blocks unauthorized access. Windows has a built-in firewall – ensure it is enabled. For extra protection, consider a hardware firewall on your router." },
                ...
                { "software updates", "Keeping your operating system, apps, and antivirus updated is one of the easiest ways to stay secure. Updates patch known security holes. Enable automatic updates where possible, and do not ignore update notifications." },
                ...
                { "help", "I am here to help! You can ask me about:\n- Passwords and 2FA\n- Phishing and scams (Quishing, Vishing, Smishing)\n- Safe browsing and VPNs\n- Malware and antivirus\n- Social media privacy and identity theft\n- Backups and updates\n- Mobile and IoT security\n- AI scams, Deepfakes, SIM swap, Zero-day\n- Cloud security and digital footprint\nType any of these keywords to learn more!" },

                // ----- ACKNOWLEDGEMENTS -----
                { "okay", "Great! Is there anything specific you would like to learn about?" },
                { "ok", "Awesome! What cybersecurity topic interests you?" },
                { "yes", "Excellent! What would you like to know more about?" },
                { "no", "No worries! Whenever you are ready, I am here to help with cybersecurity awareness." },
                { "thank you", "You are welcome! Stay safe online and remember, cybersecurity is everyone's responsibility!" },
                { "thanks", "You are welcome! Feel free to come back anytime if you have more cybersecurity questions." }
            };
        }
        ...
        public string GetResponse(string input, string userName)
        {
            ...
            if (cleanInput.Contains("how") && cleanInput.Contains("you"))
                return "I am doing great! Always ready to help you stay secure online!";
